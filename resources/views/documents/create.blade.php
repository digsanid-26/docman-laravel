<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Submit Document</h2>
    </x-slot>
                ...
                <form method="POST" action="{{ route('documents.store') }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title') }}"
                               class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 @error('title') border-red-400 @enderror"
                    ...
                    <div>
                        ...
                        <select name="document_type"
                                class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 @error('document_type') border-red-400 @enderror">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                                  class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 @error('description') border-red-400 @enderror"
                                  placeholder="Briefly describe the document contents...">{{ old('description') }}</textarea>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1">Format: PDF, DOC, DOCX, JPG, PNG. Max: 10 MB</p>
                        @error('file') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>

                    <div class="flex gap-3 pt-2">
                        <button type="submit"
                                class="flex-1 bg-red-600 hover:bg-red-700 text-white font-semibold py-2.5 px-6 rounded-lg transition">
                            Submit Document
                        </button>
